...
public class ApiControllerAdvice extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handleInvalidUserException(final InvalidUserException ex, final WebRequest request) {
		logger.info(ex.getClass().getName());
		logger.error("error", ex);
		final ApiError apiError = new ApiError(HttpStatus.INTERNAL_SERVER_ERROR, ex.getMessage(),
				"Could not save user details due to the mentioned reason");
		return new ResponseEntity<Object>(apiError, new HttpHeaders(), apiError.getStatus());
	}
	
	@ExceptionHandler({ InvalidUserRoleException.class })
	public ResponseEntity<Object> handleInvalidUserRoleException(final InvalidUserRoleException ex, final WebRequest request) {
		logger.info(ex.getClass().getName());
		logger.error("error", ex);
		final ApiError apiError = new ApiError(HttpStatus.INTERNAL_SERVER_ERROR, ex.getMessage(),
				"Could not save user details due to the mentioned reason", "Allowed roles are: ROLE_USER/ROLE_ADMIN/ROLE_OPERATOR");
		return new ResponseEntity<Object>(apiError, new HttpHeaders(), apiError.getStatus());
	}
